...
pub use file_references::{
    AnimationFileIds, AnimationTrack, BoneData, BoneFileIds, BoneNode, CollisionMesh, LodData, LodLevel, PhysicsData,
    PhysicsFileId, PhysicsMaterial, SkeletonData, SkeletonFileId, SkinFileIds, TextureFileIds,
};
pub use infrastructure::{ChunkHeader, ChunkReader};
pub use light::{M2Light, M2LightFlags, M2LightType};
pub use m2_track::{
    M2CompQuat, M2Track, M2TrackBase, M2TrackFloat, M2TrackQuat, M2TrackUint16, M2TrackVec3, M2TrackWithRanges,
};
...
pub use physics::{M2PhysicsData, M2PhysicsFlags, M2PhysicsJoint, M2PhysicsShape, M2PhysicsShapeType};
pub use rendering_enhancements::{
    AdvancedParticleSystem, AfraChunk, AlphaBlendMode, BlendMode, CollisionFace, CollisionMaterial, CollisionMeshData,
    DbocChunk, DpivChunk, EdgeFadeData, EnhancedEmitter, ExtendedAnimationMode, ExtendedAnimationProperties,
    ExtendedEmitterProperties, ExtendedParticleData, ExtendedTextureAnimation, GeometryParticleIds, LightingDetails,
    LoopBehavior, ModelAlphaData, ParentAnimationBlacklist, ParentAnimationData, ParentEventData, ParentEventEntry,
    ParentSequenceBounds, ParticleGeosetData, ParticleGeosetEntry, ParticlePhysicsProperties, PhysicsFileDataChunk,
    PhysicsProperties, RecursiveParticleIds, SequenceBounds, TextureAnimationChunk, TextureBlendMode, TextureWeight,
    WaterfallEffect, WaterfallParameters,
};
