...
impl EnhancedEmitter {
    ...
    pub fn parse<R: Read>(reader: &mut R) -> Result<Self> {
        ...
        let base_emitter = M2ParticleEmitter {
            ...
            position: crate::common::C3Vector { x: 0.0, y: 0.0, z: 0.0 },
            bone_index: 0,
            texture_indices: [0, 0, 0],
            model_filename: crate::common::M2Array::new(0, 0),
            child_emitter_filename: None,
            blending_type: 0,
            ...
            emission_speed: Default::default(),
            speed_variation: Default::default(),
            vertical_range: Default::default(),
            horizontal_range: Default::default(),
            gravity: Default::default(),
            lifespan: Default::default(),
            lifespan_variation: None,
            emission_rate: Default::default(),
            emission_rate_variation: None,
            emission_area_width: Default::default(),
            ...
            tumble_min: crate::common::C3Vector { x: 0.0, y: 0.0, z: 0.0 },
            tumble_max: crate::common::C3Vector { x: 0.0, y: 0.0, z: 0.0 },
            wind_vector: crate::common::C3Vector { x: 0.0, y: 0.0, z: 0.0 },
            wind_time: 0.0,
            ...
            spline_points: crate::common::M2Array::new(0, 0),
            enabled_in: Default::default(),
